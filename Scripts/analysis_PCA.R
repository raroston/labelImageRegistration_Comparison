...
# Step1 Deformable Transform
  # intensity-only PCA
  
    experiment = "intensityOnly"
    txPattern = "Step1_1Warp"
    baseline = "WT"
    ...
    ## Scree plot
    jpeg(filename = paste0(results.dir, "/scree.jpeg"), 
         quality = 100, 
         res = 300,
         units = "in",
         height = 5,
    ...
    for(p in seq(1, maxPC, by = 2)){
      ...
      jpeg(filename = paste0(results.dir, "/PC_plot", PCs[1], "-", PCs[2], ".jpeg"), 
           quality = 100,
           res = 300, 
           units = "in",
           height = 5,
  ...
  # label-intensity-maskAsLabel PCA
