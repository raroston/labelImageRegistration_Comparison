# Registration labelIntensity
# Rachel Roston

library(ANTsR)

# Set Directory for Registration Output
experiment = "labelIntensity-maskAsLabel"
...
# Registration Loop
  for(i in 1:nrow(metadata)){
    ...
    step1 = labelImageRegistration(fixedLabelImages = c(ref.label, ref.mask),
                                   movingLabelImages = c(mov.label, mov.mask),
                                   ...
                                   labelImageWeighting = c(1,1),
                                   outputPrefix = paste0(out.dir.transforms, "/", metadata$Subdirectory[i], "/", out.prefix, "Step1_"))
